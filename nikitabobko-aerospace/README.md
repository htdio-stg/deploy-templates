# 🚀 Generated IaC Templates for AeroSpace

> This repository contains automatically generated Infrastructure as Code templates by [DeployStack.io](https://deploystack.io/c/nikitabobko-aerospace)

## ⚡ One-Click Deploy

| Cloud Provider | Deploy Button |
|---------------|---------------|
| AWS | <a href="https://preview.3dcxy8cjkw-deploy-my.pages.dev/deploy/nikitabobko-aerospace?provider=aws&language=cfn"><img src="https://github.com/htdio-stg/deploy-templates/blob/main/.assets/img/aws.svg" height="38"></a> |
| DigitalOcean | <a href="https://preview.3dcxy8cjkw-deploy-my.pages.dev/deploy/nikitabobko-aerospace?provider=do&language=dop"><img src="https://github.com/htdio-stg/deploy-templates/blob/main/.assets/img/do.svg" height="38"></a> |
| Render | <a href="https://preview.3dcxy8cjkw-deploy-my.pages.dev/deploy/nikitabobko-aerospace?provider=rnd&language=rnd"><img src="https://github.com/htdio-stg/deploy-templates/blob/main/.assets/img/rnd.svg" height="38"></a> |
| Helm | `helm install nikitabobko-aerospace https://github.com/htdio-stg/deploy-templates/tree/nikitabobko-aerospace/helm` |
...
- **Source Repository**: https://github.com/nikitabobko/AeroSpace
- **License**: MIT License
...
Original source: https://github.com/nikitabobko/AeroSpace
